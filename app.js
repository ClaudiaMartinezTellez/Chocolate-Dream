...
const ActualizarCarrito = () => {
    ...
    //1 Limpiar el contenedor antes de utilizarlo
    //2 recorrer el arreglo (carrito) vamos acrear el html o los objetos de cada producto
    //3 anidar el elemento creado (html) al contenedor carrito
    //4 actualizar la cantidad del carrito
    //5 actualizar el precio total del carrito
    //6 guardar en local storage el contenido del carrito
